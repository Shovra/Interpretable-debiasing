...
from debias_models.energy_model.util import get_minibatch, prepare_minibatch, prepare_minibatch_adv
...
def evaluate_single(model, data, batch_size=25, device=None):
...
def evaluate(cfg, model, data, batch_size=25, device=None):
    """Accuracy of a model on given data set (using minibatches)"""
